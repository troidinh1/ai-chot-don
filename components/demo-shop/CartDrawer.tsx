        ...
        {items.length === 0 ? (
          ...
          <>
              ...
              {items.map((item) => (
                ...
                >
                  <div className="flex gap-4">
                    <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-100 to-orange-100 text-emerald-700">
                      <ProductIcon />
                    </div>
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <div className="inline-flex items-center rounded-full border border-slate-200 bg-slate-50 p-1">
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-white text-lg font-black text-slate-700 shadow-sm"
                      >
                        -
                      </button>
                      ...
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-950 text-lg font-black text-white shadow-sm"
                        style={{ color: "#ffffff" }}
                      >
                        +
                      </button>
            ...
            <div className="border-t border-slate-200 bg-white p-5">
              ...
              <button
                className="w-full rounded-2xl bg-gradient-to-r from-orange-500 to-red-500 px-5 py-4 text-sm font-black text-white shadow-lg shadow-orange-200 transition hover:scale-[1.01]"
                style={{ color: "#ffffff" }}
              >
                Tiến hành đặt hàng
              </button>
