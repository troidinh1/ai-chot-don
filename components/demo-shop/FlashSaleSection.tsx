...
export default function FlashSaleSection({
  ...
  return (
    <section id="flash-sale" className="px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2rem] border border-amber-200/70 bg-[#fffaf3] shadow-[0_10px_40px_rgba(15,23,42,0.04)]">
        <div className="flex flex-col gap-4 border-b border-amber-100 bg-white/80 px-5 py-5 sm:px-7 sm:py-6 md:flex-row md:items-center md:justify-between">
          <div>
          ...
          <div className="inline-flex items-center gap-3 self-start rounded-2xl border border-amber-100 bg-white px-4 py-3 shadow-sm md:self-auto">
...
function TimeBox({ value }: { value: string }) {
  return (
    <span className="inline-flex min-w-[38px] items-center justify-center rounded-xl bg-amber-50 px-2.5 py-2 text-sm font-black text-amber-700">
      {value}
    </span>
  );
}
